...
insert into app01_member(id,email,mobile_no,username,password,role_id,registration_date,membership_id,points_bal,total_points) values(1,'aa@gmail.com','root','root','root1234',1,'2018-06-01',1,0,0),(2,'bb@gmail.com','pos','pos','root1234',2,'2018-06-01',1,0,0),(3,'cc@gmail.com','member01','member01','root1234',3,'2018-06-01',1,0,0),(4,'dd@gmail.com','app','app','root1234',5,'2018-06-01',1,0,0);
...
insert into app01_token(key,user_id,created) values('fa3c5db850ada70422a02e4638984dc08822f010',1,'2018-06-01'),('62c366bacc6365c035fad818d2a77be51097e95d',2,'2018-06-01'),('1336161b67b86cf40faa3a86f8cb6b9e32dca5e3',3,'2018-06-01'),('6c184f9c121c117a999b8f060c8f154e0af450fd',4,'2018-06-01');
